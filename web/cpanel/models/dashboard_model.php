...
class Dashboard_Model extends Model {
	...
	function xhrInsert()
	{
		...
		$this->db->insert('news_launcher', ['title' => $title, 'message' => $message, 'newslink' => $newslink, 'imagelink' => $imagelink, 'realms' => $realms, 'date_time' => $date_today]);

		$data = array('title' => $title, 'ORDER BY id DESC' => $this->db->lastInsertId());
